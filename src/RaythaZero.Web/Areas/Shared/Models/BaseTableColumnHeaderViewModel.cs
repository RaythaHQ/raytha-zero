...
public record BaseTableColumnHeaderViewModel
{
    ...
    public string OrderBy
    {
        get
        {
            return Pagination.OrderByPropertyName == PropertyName && Pagination.OrderByDirection == "desc" ? $"{PropertyName} asc" : $"{PropertyName} desc";
        }
    }
    ...
    public bool IsCurrentlySorting
    {
        get
        {
            return Pagination.OrderByPropertyName == PropertyName;
        }
    }
}