...
public class Index : BaseAdminPageModel
{
    ...
    { 
        ...
        if (!response.Success)
        {
            ...
            ListView = new ListViewModel<AuditLogsListItemViewModel>(new List<AuditLogsListItemViewModel>(), 0);
        }
        else
        {
            ...
            ListView = new ListViewModel<AuditLogsListItemViewModel>(items, response.Result.TotalCount);
        }
