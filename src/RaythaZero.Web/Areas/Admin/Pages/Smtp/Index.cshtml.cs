...
namespace RaythaZero.Web.Areas.Admin.Pages.Smtp;
...
public class Index : BaseAdminPageModel
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        Form = new FormModel 
        {
            SmtpOverrideSystem = MissingSmtpEnvironmentVariables || response.Result.SmtpOverrideSystem,
    ...
    {
        var input = new RaythaZero.Application.OrganizationSettings.Commands.EditSmtp.Command
        {
