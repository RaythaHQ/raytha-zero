...
namespace RaythaZero.Web.Areas.Admin.Pages.Configuration;
...
public class Index : BaseAdminPageModel
{
    ...
    {
        var input = new RaythaZero.Application.OrganizationSettings.Commands.EditConfiguration.Command
        {
        ...
        {
            SetErrorMessage("There was an error attempting to save the configuration. See the error below.", response.GetErrors());
            return Page();
        }
    }
