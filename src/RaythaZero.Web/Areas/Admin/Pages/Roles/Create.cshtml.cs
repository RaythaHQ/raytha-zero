...
public class Create : BaseAdminPageModel
{
    ...
    {
        var systemPermissions = BuiltInSystemPermission.Permissions.Select(p => new FormModel.SystemPermissionCheckboxItem_ViewModel
        {
    ...
    public async Task<IActionResult> OnPost()
    {
        var input = new CreateRole.Command
        {
            ...
            SystemPermissions = Form.SystemPermissions.Where(p => p.Selected).Select(p => p.DeveloperName)
        };
