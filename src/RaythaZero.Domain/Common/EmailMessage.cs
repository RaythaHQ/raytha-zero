...
public record EmailMessage
{
    ...
    public IEnumerable<EmailMessageAttachment> Attachments { get; init; } = new List<EmailMessageAttachment>();

    public EmailMessage() { }

    private EmailMessage(string subject, string content, string to, string fromEmailAddress, string fromName)
    {
        Subject = subject;
        Content = content;
        IsHtml = true;
    ...
    public static EmailMessage From(string subject, string content, string to, string fromEmailAddress, string fromName)
    {
