...
namespace RaythaZero.Application.Users.Commands;
    ...
    public class Validator : AbstractValidator<Command>
    {
            ...
            ICurrentUser currentUser)
        {
            RuleFor(x => x).Custom((request, context) =>
            {
                ...
                {
                    context.AddFailure(Constants.VALIDATION_SUMMARY, "You cannot delete your own account.");
                    return;
                }
                ...
                if (entity.IsAdmin)
                {
                    context.AddFailure(Constants.VALIDATION_SUMMARY, "You cannot delete another administrator account.");
                    return;
                }
            });
        }
